...
//                 to: [{ email: recipientEmail, name: recipientName }],
//                 subject: `Informe de Rendimiento para ${url}`,
//                 htmlContent: `
//                     <html>
//                         <body>
//                             <h1>Informe de Rendimiento</h1>
//                             <p>Hola ${recipientName},</p>
//                             <p>Gracias por utilizar CaptivAI. Aquí tienes el análisis de rendimiento para la página <strong>${url}</strong>.</p>
//                             ${formattedReport} <!-- Aquí se incluye el contenido HTML del informe -->
//                             <p>Saludos,<br>El equipo de CaptivAI</p>
//                         </body>
//                     </html>
//                 `,
//             },
